 ...
 */
public class ExFileView implements View {

    // Constants ----------------------------------------------------------------------------------

    private static Logger logger = LoggerFactory.get(ExFileView.class);
    private static final int DEFAULT_BUFFER_SIZE = 10240; // ..bytes = 10KB.
    private static final long DEFAULT_EXPIRE_TIME = 604800000L; // ..ms = 1 week.
    private static final String MULTIPART_BOUNDARY = "MULTIPART_BYTERANGES";
    private File file;
    private String fileName ;
    public ExFileView(File file) {
    	this.file=file;
    }

    public ExFileView(File file,String fileName) {
        this.file=file;
            ...
            throws IOException
    {
        ...
        String fileName = StringUtil.isEmpty(this.fileName)?file.getName():this.fileName;
	...
	public void render(Context ctx) throws IOException {
		processRequest(ctx.request().raw(),ctx.response().raw(),true);
	}
