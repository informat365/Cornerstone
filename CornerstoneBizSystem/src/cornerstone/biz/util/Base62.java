...
public class Base62 {
     ...
     * @return
     */
    public String encodeString(final byte[] message) {
        final byte[] indices = convert(message, STANDARD_BASE, TARGET_BASE);
        return new String(translate(indices, alphabet),Charset.forName("utf-8"));
    }
    ...
    public String decodeString(final String encoded) {
    	return new String(decode(encoded.getBytes(Charset.forName("utf-8"))));
    }
