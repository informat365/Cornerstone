...
public class SensitiveFilter implements Serializable{
	...
	private static Logger logger = LoggerFactory.get(SensitiveFilter.class);
	...
	public static final SensitiveFilter DEFAULT = new SensitiveFilter(
			new BufferedReader(new InputStreamReader(
					Jazmin.getAppClassLoader().getResourceAsStream("cornerstone/biz/util/sensi/sensi_words.dict")
