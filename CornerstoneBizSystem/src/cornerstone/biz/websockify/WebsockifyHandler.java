...
import cornerstone.biz.websockify.WebsockifyServer.HostInfo;
...
public class WebsockifyHandler extends SimpleChannelInboundHandler<Object> {
    ...
    @Override
    public void messageReceived(ChannelHandlerContext ctx, Object msg) throws InterruptedException {
    ...
    private void handleHttpRequest(
        ...
        hostInfo.host = connectionInfo.host;
        hostInfo.password = connectionInfo.password;
        hostInfo.port = connectionInfo.port;
        //
        // Handshake
