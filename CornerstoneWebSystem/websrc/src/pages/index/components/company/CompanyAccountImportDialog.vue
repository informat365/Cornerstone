...
<i18n>
{
 ...
 <template>
    <Modal
        ...
        :loading="false" :title="$t('导入成员')" width="700" >
    ...
    <div slot="footer">
        <Row>
            <Col span="12" style="text-align:left;padding-top:5px"><a href="/template/user_template.xlsx">下载模板</a></Col>
...
<script>
    export default {
        ...
        methods: {
            ...
            confirm(){
                app.invoke('BizAction.importCompanyAccountFromExcel',[app.token,this.fileUUID],(info)=>{
                    app.toast('导入成功');
