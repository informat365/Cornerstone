...
<i18n>
    ...
    "zh_CN": {
    "对象类型": "对象类型",
    "自定义状态流转图":"自定义变更审批状态流转图,点击下图中的单元格可以修改流转设置",
    "流转设置":"流转设置",
    "可流转到":"可流转到",
    "流转图":"流转图",
    "保存":"保存",
    ...
    export default {
        ...
        methods: {
            loadData() {
                ...
                app.invoke('TaskAlterationAction.getTaskAlterationDefineList', [app.token, query], (list) => {
            ...
            confirm() {
                ...
                this.dataList.forEach(item => {
                    dataList.push({
                        ...
                        permissionOwnerList: item.permissionOwnerList,
                ...
                app.invoke('TaskAlterationAction.saveTaskAlterationDefineList', [app.token, dataList], (list) => {
                    app.toast(this.$t('保存成功'));
                });
            },
            showStatusEditDialog(item) {
                app.showDialog(ProjectSettingAlterationEditDialog, {
                    item: item,
