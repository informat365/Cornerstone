...
<i18n>
{
 ...
 <template>
    <Modal
        ...
        :loading="false" :title="$t('导入系统')" width="700" >
    ...
    <div slot="footer">
        <Row>
            <Col span="12" style="text-align:left;padding-top:5px"><a href="/template/系统清单模板.xlsx">下载模板</a></Col>
...
<script>
    export default {
        ...
        methods: {
            ...
            confirm(){
                app.invoke('BizAction.importCompanyVersionRepositoryFromExcel',[app.token,this.fileUUID],(info)=>{
                    app.toast('导入成功');
