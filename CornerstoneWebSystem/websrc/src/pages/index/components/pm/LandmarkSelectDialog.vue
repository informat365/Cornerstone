    ...
    <Modal
        ...
        <div class="page">
            <Form inline>
                ...
                <FormItem>
                    <DataDictSelect clearable style="width: 160px;" placeholder="状态" v-model="formItem.status" type="Stage.status"></DataDictSelect>
                </FormItem>
                <FormItem>
    ...
    export default {
        ...
        methods: {
            pageLoad() {
                ...
                this.formItem.singleSelect = this.args.singleSelect;
                if(!!this.args.id){
                    this.formItem.idNotInList=[this.args.id]
                }
                if(!!this.args.idNotInList){
            ...
            loadData() {
                ...
                app.invoke('BizAction.getLandmarkList', [app.token, formItem], info => {
                    this.tableData = info;
                });
            },
            getSelectedCount() {
