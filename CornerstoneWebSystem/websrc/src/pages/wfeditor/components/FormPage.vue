    ...
    <div class="page">
        <div class="toolbox scrollbox">
            <Form label-position="top">
                <FormItem v-for="group in ['基础组件','静态字段','成员部门','高级组件']" :label="$t(group)" :key="'g'+group">
        ...
        <div class="form-box scrollbox" @click="selectFormItem(null)">
            <div class="form">
                ...
                <div class="form-subtitle-row"><input v-model.trim="formItem.subTitle" type="text" :placeholder="$t('请输入副标题')"/></div>
...
export default {
    ...
    data(){
        return {
            ...
            formItemTypeList:[
                ...
                {group:'基础组件',name:'富文本',id:'text-rich',width:100},
                ...
                {group:'基础组件',name:'表格',id:'table',columnList:[]},
                //
                ...
                //
                {group:'成员部门',name:'成员选择',id:'user-select',countType:'single'},
                {group:'成员部门',name:'部门选择',id:'department-select',countType:'single'},
                {group:'成员部门',name:'企业角色',id:'role-company-select',countType:'single'},
                {group:'成员部门',name:'项目角色',id:'role-project-select',countType:'single'},
                //
                {group:'高级组件',name:'系统字段',id:'system-value',systemValueType:'submitAccount'},
            ],
            formItemList:[],
            editFormItem:null,
        }
    ...
    methods:{
        ...
        loadData(){
            app.invoke('WorkflowAction.getWorkflowFormDefineById',[app.token,
                this.workflowDefine.id],(info)=>{
                this.formItem=info;
                try{
                    if(info.fieldList){
        ...
        confirm(callback){
            ...
            app.invoke('WorkflowAction.updateWorkflowFormDefine',[app.token,this.formItem],(info)=>{
