...
<div class="app-frame">
    ...
    <div class="note-info">{{note.createAccountName}} · {{note.updateTime|fmtDateTime}}</div>
    <div class="simditor richtext-box" style="border:none">
        <div class="simditor-body richtext-body" v-html="note.content"></div>
    </div>
</div>
</template>
<script>
...
export default {
    ...
    methods: {
        loadData(id){
            ajaxInvoke(this.serverAddr+'/p/api/invoke/','NoteAction.getNoteByShareUuid',[id],(t)=>{
