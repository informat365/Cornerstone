/*!
 * ====================================================
 * cornerstone-kityminder-editor - v1.0.0 - 2019-07-22
...
angular.module('kityminderEditor').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui/directive/kityminderEditor/kityminderEditor.html',
    "<div class=\"minder-editor-container\"><div class=\"top-tab\"><div class=\"tab-content\"><div class=\"tab-pane active\" new-top=\"minder\" editor=\"editor\" ng-if=\"minder\"></div></div></div><div search-box minder=\"minder\" ng-if=\"minder\"></div><div class=\"minder-editor\" style=\"top: 60px\"></div><div class=\"km-note\" note-editor minder=\"minder\" ng-if=\"minder\" style=\"top: 60px\"></div><div class=\"note-previewer\" note-previewer ng-if=\"minder\"></div><div class=\"navigator\" navigator minder=\"minder\" ng-if=\"minder\"></div></div>"
  );
  ...
  $templateCache.put('ui/directive/newTop/newTop.html',
    "<hyper-link minder=\"minder\"></hyper-link><image-btn minder=\"minder\"></image-btn><note-btn minder=\"minder\"></note-btn><priority-editor minder=\"minder\"></priority-editor><style-operator minder=\"minder\" class=\"inline-directive\"></style-operator><font-operator minder=\"minder\" class=\"inline-directive\"></font-operator><template-list minder=\"minder\" class=\"inline-directive\"></template-list><theme-list minder=\"minder\"></theme-list><layout minder=\"minder\" class=\"inline-directive\"></layout><expand-level minder=\"minder\"></expand-level><select-all minder=\"minder\"></select-all><search-btn minder=\"minder\"></search-btn>"
  );
        ...
        $scope.uploadImage = function () {
            ...
            if (/^.*\.(jpg|JPG|jpeg|JPEG|gif|GIF|png|PNG)$/.test(fileInput.val())) {
                ...
                return server.uploadImage(file).then(function (json) {
                    var resp = json.data || json;
                    if (resp.errno === 0 || resp.success === true) {
                        $scope.data.url = (resp.data && resp.data.url) || resp.full_path;
                    }
                });
            } else {
...
angular.module('kityminderEditor')
    .directive('newTop', function() {
       return {
           restrict: 'A',
           templateUrl: 'ui/directive/newTop/newTop.html',
           scope: {
               minder: '=newTop',
               editor: '='
           },
