...
(function (root, factory) {
  ...
  Formatter = (function(superClass) {
    ...
    Formatter.prototype.cleanNode = function(node, recursive) {
    	if( this.editor.cleanNodeFormat==true){
    		return;
    	}
...
Dropzone = (function(_super) {
  ...
  Dropzone.prototype._init = function() {
    ...
    $(this.editor.el[0]).on("dragover", function(e) {
      e.originalEvent.dataTransfer.dropEffect = "none";
      return e.preventDefault();
    });
    $(this.editor.el[0]).on('drop', function(e) {
      return e.preventDefault();
    });
...
SimditorMention = (function(superClass) {
  ...
  SimditorMention.prototype.refresh = function() {
    ...
    if (targetOffset.top - $(document).scrollTop() + popoverH > ($(window).height()-20)) {
